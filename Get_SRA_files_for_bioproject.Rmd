...
#   fq_dump_srr <- paste0(STRtk_dir,"fastq-dump"," --gzip --skip-technical --dumpbase --split-files --clip ", SRRshortlist)

# or get all files from the project
fq_dump_srr <- paste0(STRtk_dir," --gzip --skip-technical --dumpbase --split-files --clip ", SRRrun)
